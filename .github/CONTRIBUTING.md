# Contributing Guidelines for agent-epaye-registration-frontend

Hi!  Thanks for taking the time to contribute to the [HMRC Multichannel Digital Tax Platform](https://hmrc.github.io) (MDTP)

We welcome contributions to agent-epaye-registration-frontend.  By following these guidelines you will greatly improve the likelihood of your change being accepted and merged.
...
Please come and talk to us in our [Slack channel](https://hmrcdigital.slack.com/archives/team-ddct-liveservice) in the first instance.  Once we've discussed your idea, we'll probably ask you to [raise an issue](https://github.com/hmrc/agent-epaye-registration-frontend/issues/new) (using our [Issue template](.github/ISSUE_TEMPLATE.md)) before starting work.

## Contributing code

Once you've identified (or created) an [issue](https://github.com/hmrc/agent-epaye-registration-frontend/issues) to work on, please follow these guidelines to contribute code:
