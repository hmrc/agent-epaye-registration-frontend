...
trait CheckYourAnswersHelper extends SummaryListRowHelper {
  ...
  def makeRow()(using request: DataRequest[?], messages: Messages): Option[SummaryListRow] =
  ...
  def makeContactDetailsRow()(using request: DataRequest[?], messages: Messages): Option[SummaryListRow] =
  ...
  def makeBusinessAddressRow()(using request: DataRequest[?], messages: Messages): Option[SummaryListRow] =
  ...
  def makeSummary()(using request: DataRequest[?], messages: Messages): Seq[SummaryListRow] =
    Seq(
      makeRow(),
